...
public class MBorrowPanel extends JPanel implements BorrowPanel{
	...
	public MBorrowPanel() {
		...
		JLabel lblNewLabel_2 = new JLabel("条件查询");
		...
		JLabel lblNewLabel_3 = new JLabel("功能性查询");
		...
		JButton btnOverdue = new JButton("逾期查询");
		btnOverdue.setForeground(new Color(255, 255, 255));
		btnOverdue.setBackground(new Color(0, 51, 153));
		MaterialUIMovement.add(btnOverdue, new Color(0,100,180));
		btnOverdue.setFont(new Font("微软雅黑", Font.PLAIN, 18));
		...
		MaterialUIMovement.add(btnSearch, new Color(255,140,110));
		...
		btnRenewal.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Library.renewalBorrow(MBorrowPanel.this, b);
			}
		});
		...
		btnReturn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				BookBorrowRecBean b=recordList.get(idx);
				Library.returnBook(MBorrowPanel.this, b);
			}
	...
	public static void main(String[] args) {
		...
		frame.setContentPane(new MBorrowPanel());
