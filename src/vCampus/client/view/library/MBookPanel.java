...
public class MBookPanel extends JPanel implements BookPanel{
	...
	public MBookPanel() {
		...
		gbl_page.columnWeights = new double[]{1.0, 0.0, 3.0, 0.0, 1.0, Double.MIN_VALUE};
		...
		lblNewLabel.setIcon(new ImageIcon(MBookPanel.class.getResource("/education/002.png")));
		...
		btnBorrow = newOperationButton("借出");
		btnOrder = newOperationButton("预约");
		//----------------------------------------------
